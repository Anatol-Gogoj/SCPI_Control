...
SEGMENT_PARAMS = {
    'LINE': [],
    'HOLD': [],
    'SINE': [('cycles', 'Cycles', 1.0, False), ('amp', 'Amplitude (V)', 0.5, False),
             ('offset', 'Offset (V)', 0.0, True), ('phase', 'Phase (deg)', 0.0, True)],
    'SQUARE': [('cycles', 'Cycles', 1.0, False), ('amp', 'Amplitude (V)', 0.5, False),
               ('duty', 'Duty Cycle (%)', 50.0, False),
               ('offset', 'Offset (V)', 0.0, True), ('phase', 'Phase (deg)', 0.0, True)],
    'RAMP': [('cycles', 'Cycles', 1.0, False), ('amp', 'Amplitude (V)', 0.5, False),
             ('sym', 'Symmetry (%)', 50.0, False),
             ('offset', 'Offset (V)', 0.0, True), ('phase', 'Phase (deg)', 0.0, True)],
    'PULSE': [('cycles', 'Cycles', 1.0, False), ('amp', 'Amplitude (V)', 0.5, False),
